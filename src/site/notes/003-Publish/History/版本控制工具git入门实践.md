...
![all branch](https://fodi.389266.xyz/images/IMG-af5ae175b5228177.webp)
...
* 已修改（modified）：修改了某个文件，但还没有保存，此外还有从没有add过的新文件，**未追踪untracked**
  ...
  ![git status](https://fodi.389266.xyz/images/IMG-5bac7993b4e8db8c.webp)
...
* merge完成时，被合入分支的最后一个commit在待合入分支之中，移动HEAD到最后一个commit。如下图所示：
  ...
  ![fast forward](https://fodi.389266.xyz/images/IMG-9b834d017fbfa2b5.webp)
